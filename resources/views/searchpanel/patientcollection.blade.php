...
@section('body')
    <div class="flex justify-center items-center" id="printarea">
        <div class="w-[80%] mt-3">
            {{-- <h1 class="text-center text-2xl font-semibold">Patient Collection Record</h1> --}}
            <div class="flex justify-around">
                <div>
                    <select name="doctor" class="w-40 capitalize px-1">
                        <option value="select1">Doctor Reference</option>
                        <option value="select2">select2</option>
                    </select>
                    <select name="doctor" class="w-40 capitalize px-1">
                        <option value="select1">Center Reference</option>
                        <option value="select2">select2</option>
                    </select>
                    <select name="doctor" class="w-40 capitalize px-1">
                ...
                <h1 class="text-center text-xl font-semibold">Patient Collection Record</h1>
            </div>
