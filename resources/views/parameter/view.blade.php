...
@section('body')
    <div class="flex justify-center items-center">
        <div class="w-[70%] flex flex-col justify-center items-center mt-5">
            ...
            @endif
            {{-- <div><hr class="border-blue-800 w-full" /></div> --}}
            <div class="mt-5 flex w-[60%] flex-col justify-center items-center">
                ...
                <div class="w-full flex flex-col gap-2 bg-gray-200 px-3 py-2 mt-3">
                    ...
                    @forelse ($tests as $test)
                        <details class="border p-1 px-3 rounded-md bg-gray-700 text-white">
                            <summary class="capitalize flex justify-between">
                                <p class="flex gap-2"><span><img src="/icons/dropdown.png" alt="dropdown" class="w-6"></span><span>{{ $test->test_name }}</span></p>
                                <div class="flex gap-10">
                                    <p>{{ $test->test_price }} /-</p>
                                    <p class="border px-3 bg-white text-black">{{ $test->para->count() }}</p>
                                </div>
                            </summary>
                            @forelse ($test->para as $parameter)
                                <li>{{ $parameter->sub_test_name }}</li>
                            @empty
                                <p>No Parameter Entered!</p>
                            @endforelse
                        </details>
                ...
                {{-- <table class="border mt-1 w-full">
                    ...
                    <tbody class="border" id="tests-table-body">
                        @forelse ($tests as $dd)
                            ...
                            <ul>
                                @foreach ($test->para as $parameter)
